...
#pandaUid = p.loadURDF("mycobot_description/urdf/600_urdf/mycobot_600_urdf.urdf",useFixedBase=True)
#pandaUid = p.loadURDF("mycobot_description/urdf/mycobot/mycobot_urdf.urdf",useFixedBase=True)
...
#objectUid = p.loadURDF("mycobot_description/urdf/320_urdf/mycobot_pro_320.urdf",basePosition=[0.7,0,0.1])
#objectUid = p.loadURDF("mycobot_description/urdf/600_urdf/mycobot_600_urdf.urdf",basePosition=[0.7,0,0.1])
